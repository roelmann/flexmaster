...
From your Moodle theme directory right click on flexmaster and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of flexmaster.
...
underscores. For the purpose of this tutorial we will call the theme 'flexmastertheme'.

On opening 'flexmastertheme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case flexmaster. So using the above list as
a guide, search through and change all the instances of the theme name
'flexmaster' to 'flexmastertheme'. This includes the filename of the lang/en/theme_flexmaster.php.
You need to change this to 'theme_flexmastertheme.php'.
